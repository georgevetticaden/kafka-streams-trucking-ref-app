...
public class SpeedingDriverAlertsConsumer extends BaseStreamsApp {
	...
	public SpeedingDriverAlertsConsumer(Properties configs) {
		super(configs);
	...
	public static void main(String[] args) {
		...
		SpeedingDriverAlertsConsumer speedStreamConsumer = new SpeedingDriverAlertsConsumer(kafkaConfig);
