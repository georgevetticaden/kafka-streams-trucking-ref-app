...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "g-dps-connected-dp11.field.hortonworks.com:6667");
        ...
        builder.<String, String>stream("streams-plaintext-input-v2")
               .flatMapValues(value -> Arrays.asList(value.toLowerCase(Locale.getDefault()).split("\\W+")))
               .groupBy((key, value) -> value)
               .count(Materialized.<String, Long, KeyValueStore<Bytes, byte[]>>as("counts-store"))
               .toStream()
               .to("streams-wordcount-output-v2", Produced.with(Serdes.String(), Serdes.Long()));

        final Topology topology = builder.build();
        
        logger.debug("WordCount Kafka Streams Topology: " + topology.describe());
